...
private final String SHOPPING_RESULT_PAGE = "cart.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.fetchAllGames();
            Map<String, ShoppaDTO> gamesList = dao.getGamesList();
            ...
            request.getRequestDispatcher(SHOPPING_RESULT_PAGE).forward(request, response);
        }
    }
