        ...
        try {
            ...
            if (session != null) {
                ...
                if (cart != null) {
                    ...
                    if (items != null) {
                        //4. Khách hàng chọn đồ bị xóa
                        String[] selectedList = request.getParameterValues("cboBox");
            ...
            //6. Gọi lại chức năng view cart
            String urlRewriting = "DispatchServlet?" + "btnAction=View Cart";
